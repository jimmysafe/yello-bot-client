...
const links = [
	...
	{ name: 'Support', path: '/support', private: false },
		...
		<header className='py-4 px-4'>
			<nav className='container mx-auto flex justify-between items-center'>
				<div className='flex items-center cursor-pointer' onClick={() => router.push('/')}>
					...
					<span className='font-secondary text-primary font-medium text-md ml-3 uppercase'>
						yello
					</span>
				</div>
				<div className='flex justify-between items-center'>
					...
					{data && (
						<>
							...
							/>
							<div
								className='mx-5 cursor-pointer items-center relative hidden md:flex'
								onClick={() => logout()}
							>
